...
%% low-level
encode(Val, Type, pg_idatetime) ->
    pg_idatetime:encode(Type, Val);
encode(Val, Type, pg_fdatetime) ->
    pg_fdatetime:encode(Type, Val).

decode(Bin, Type, pg_idatetime) ->
    pg_idatetime:decode(Type, Bin);
decode(Bin, Type, pg_fdatetime) ->
    pg_fdatetime:decode(Type, Bin).
